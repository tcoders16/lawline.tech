...
<motion.main
  ...
  className="min-h-screen bg-white text-neutral-900 flex items-center justify-center px-4 sm:px-6 chakra-petch-regular"
>
    <main className="min-h-screen bg-white text-neutral-900 flex items-center justify-center px-4 sm:px-6 pt-20 pb-16 chakra-petch-regular">
      <div className="max-w-3xl w-full text-center space-y-10 sm:space-y-12">

        {/* Title */}
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight leading-tight relative inline-block">
          Lawline
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 1418 125"
            className="absolute -bottom-[3.9px] left-0 w-full h-[12px] sm:h-[14px]"
        ...
        {/* Subtitle */}
        <p className="text-base sm:text-lg md:text-xl text-gray-600 italic leading-relaxed">
        ...
        <motion.div
            ...
            className="text-sm sm:text-base md:text-lg text-gray-800 leading-relaxed space-y-1"
            >
            <p>
        ...
        {/* Value Prop with elegant hover + pulsing animations */}
            <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            ...
            >
            <p className="text-sm sm:text-lg font-semibold text-gray-900 tracking-tight">
                Save up to{" "}
                <motion.span
                animate={{ scale: [1, 1.08, 1] }}
                transition={{ repeat: Infinity, duration: 2, ease: "easeInOut" }}
                className="bg-emerald-100 px-2 py-0.5 rounded text-emerald-800 font-bold inline-block shadow-sm mr-2 ml-2"
                >
                $200K/year
                </motion.span>{" "}
                in legal ops
        ...
        <div className="flex justify-center">
          <span className="inline-flex items-center gap-2 sm:gap-3 px-5 py-2 rounded-full border border-green-500 bg-gradient-to-r from-green-50 via-green-100 to-green-50 text-green-800 text-xs sm:text-sm font-semibold shadow-[0_4px_12px_rgba(72,187,120,0.4)] backdrop-blur-md transition-all duration-300
            hover:bg-emerald-100 hover:border-2 hover:border-emerald-600 hover:shadow-inner hover:brightness-110 hover:text-green-900 hover:font-bold group">
