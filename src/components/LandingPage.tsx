...
const LandingPage: React.FC = () => {
  return (
    <motion.main
      ...
      className="min-h-screen bg-white text-neutral-900 flex flex-col justify-center px-4 sm:px-6 md:px-8 lg:px-10 xl:px-20 2xl:px-36 pt-20 pb-16 chakra-petch-regular"
    >
      <div className="w-full max-w-screen-lg 2xl:max-w-screen-xl mx-auto text-center space-y-10 sm:space-y-12">
        ...
        {/* Subtitle */}
        <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 italic leading-relaxed">
        ...
        <section className="flex items-center justify-center px-4 sm:px-6">
          <div className="space-y-6 text-center">
            <EmailSubscribe />
            <p className="text-gray-900 text-base sm:text-lg md:text-xl">Skip the stack. Start building.</p>
          </div>
        </section>
