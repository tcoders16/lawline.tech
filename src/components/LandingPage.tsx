...
<h1 className="relative inline-block text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-extrabold tracking-tight leading-tight">
  ...
  <svg
    ...
    className="absolute -bottom-[7px] left-0 w-full h-[14px] z-0"
  >
    <path
    ...
    />
        ...
        {/* Subtitle */}
<p className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl text-gray-600 italic leading-relaxed text-center px-4 max-w-screen-md mx-auto">
