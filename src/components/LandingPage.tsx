  ...
  return (
    ...
    >
      <div className="w-full max-w-screen-lg 2xl:max-w-screen-xl mx-auto flex flex-col items-center justify-center text-center space-y-10 sm:space-y-12 min-h-[85vh] pt-[10vh]">
        ...
        {/* Title */}
        <h1 className="relative inline-block font-extrabold tracking-tight leading-tight text-center">
          <span className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-[6rem] relative z-10 block mb-5">
            Lawline
          </span>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 1418 125"
            className="w-full h-2 sm:h-3 md:h-4 lg:h-5 xl:h-h-[16px] 2xl:h-[22px] absolute bottom-0 left-0"
        ...
        {/* Subtitle */}
      <p className="text-sm sm:text-base md:text-md lg:text-lg xl:text-xl 2xl:text-xl text-gray-600 italic leading-relaxed text-center px-4 max-w-screen-md mx-auto">
