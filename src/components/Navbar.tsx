...
export default function Navbar() {
  return (
    <header className="w-full bg-white border-b border-zinc-200 px-4 py-3 flex items-center justify-between font-chakra-regular">
      <Link to="/" className="relative inline-flex text-gray-700 text-2xl chakra-petch-light">
        ...
        <span className="relative inline-block ml-1">
          ...
          <svg
            ...
            className="absolute bottom-[1.9px] left-0 w-full h-[3px]" // Adjust height as needed
      ...
      <nav className="space-x-6 text-sm text-zinc-700">
        ...
        <Link to="/generate" className="hover:text-black">
          Get started
        </Link>
      ...
      <div className="space-x-3 text-sm">
        <button className="px-4 py-1 border border-zinc-300 rounded hover:bg-zinc-100 text-black">
          Log in
        </button>
